...
;(function(ng, _) {
 ...
 /*module.run([
  ...
  $templateCache.put('templates/options/tinkText.html',
    " <div class=form-group> <label for=question>Question</label> <textarea ng-change=rerender() ng-model-options=\"{ updateOn: 'blur' }\" id=question ng-model=field.label placeholder=question rows=2></textarea> </div>  <div class=form-group> <label for=placeholder>placeholder</label> <input ng-change=rerender() ng-model-options=\"{ updateOn: 'blur' }\" ng-model=field.placeholder id=placeholder> </div>  <div class=form-group> <label for=description>Description</label> <textarea ng-change=rerender() ng-model-options=\"{ updateOn: 'blur' }\" ng-model=field.shortDescription id=description placeholder=description rows=2></textarea> </div>  <div class=form-group> <label for=extraInfo>Extra information</label> <textarea ng-change=rerender() ng-model-options=\"{ updateOn: 'blur' }\" ng-model=field.extraInfo id=extraInfo placeholder=extraInfo rows=2></textarea> </div>  <div class=checkbox> <input ng-change=rerender() ng-model-options=\"{ updateOn: 'blur' }\" ng-model=field.shortDescription type=checkbox id=Required name=Required checked> <label for=Required>Required</label> </div>  <div class=form-group> <input ng-change=rerender() ng-model-options=\"{ updateOn: 'blur' }\" ng-model=field.extraOptions.extraInfo id=extra name=extra> <label for=extra>extra</label> </div>"
  );
